...
ClapTrap::ClapTrap(const string& name) : _hit_point(0), _max_hit_points(0), _energy_points(0), \
	_max_energy_points(0), _level(0), _name(name), _melee_attack_damage(0), _ranged_attack_damage(0), \
